...
42. [#042 - Queue Worker: Concurrency=N + Retry + DLQ](./kata/kata042.md)
43. [#043 - Circuit Breaker (Open / Half-open / Close + Metrics)](./kata/kata043.md)
44. [#044 - Bulkhead Isolation: tách resource per route](./kata/kata044.md)
45. [#045 - Priority Queue: SLA-aware processing](./kata/kata045.md)
46. [#046 - Load Shedding: drop/deny chiến lược khi quá tải](./kata/kata046.md)
47. [#047 - Adaptive Concurrency: tăng/giảm concurrency theo latency](./kata/kata047.md)
48. [#048 - Streaming Upload: upload file không buffer toàn bộ](./kata/kata048.md)
49. [#049 - Fan-out Control: parallel calls có cap + cancel](./kata/kata049.md)
50. [#050 - Thundering Herd: Cache Stampede Protection](./kata/kata050.md)
51. [#051 - Golden Signals](./kata/kata051.md)
52. [#052 - Tracing with Context](./kata/kata052.md)
53. [#053 - Log Sampling Strategy](./kata/kata053.md)
54. [#054 - Custom Metrics: Histogram p50/p95/p99](./kata/kata054.md)
55. [#055 - Health vs Readiness](./kata/kata055.md)
56. [#056 - Alert Design (SLO-ish)](./kata/kata056.md)
57. [#057 - Debug Mode Safe](./kata/kata057.md)
58. [#058 - Correlation IDs qua Message Queue](./kata/kata058.md)
59. [#059 - Incident Repro Harness](./kata/kata059.md)
60. [#060 - Postmortem Template](./kata/kata060.md)
61. [#061 - Secrets Handling: load, rotate, never log](./kata/kata061.md)
62. [#062 - AuthN/AuthZ: RBAC + ABAC “nhỏ nhưng chuẩn”](./kata/kata062.md)
63. [#063 - JWT Pitfalls: issuer/audience, clock skew, rotation](./kata/kata063.md)
64. [#064 - CSRF/CORS Correct: rule set + tests](./kata/kata064.md)
65. [#065 - Input Sanitization: sanitize đúng chỗ, đúng ngữ cảnh](./kata/kata065.md)
66. [#066 - Dependency Risk: audit + lockfile strategy](./kata/kata066.md)
67. [#067 - DoS by JSON: limit body, depth, arrays](./kata/kata067.md)
68. [#068 - SSRF Prevention: allowlist + block internal ranges](./kata/kata068.md)
69. [#069 - File Upload Security: sniff MIME, limit size, safe store](./kata/kata069.md)
70. [#070 - Security Logging: Minimal Viable Audit Trail](./kata/kata070.md)
71. [#071 - Hexagonal Boundary: Domain / Application / Infra tách đúng chuẩn](./kata/kata071.md)
72. [#072 - Dependency Inversion in TS: Composition Root](./kata/kata072.md)
73. [#073 - Feature Flagging: Runtime Flags + Kill Switch](./kata/kata073.md)
74. [#074 - Config System: Layered + Schema + Reload](./kata/kata074.md)
75. [#075 - Monolith Modularization: Module Boundaries & Rules](./kata/kata075.md)
76. [#076 - Event-driven Module: Internal Typed Event Bus](./kata/kata076.md)
77. [#077 - Anti-corruption Layer: Adapter cho External API](./kata/kata077.md)
78. [#078 - Library Design: Publish Internal Package với SemVer](./kata/kata078.md)
79. [#079 - Refactor with Contract Tests: Change Implementation, Preserve Behavior](./kata/kata079.md)
80. [#080 - Migration: Mono → Services: Carve-out Plan cho 1 Module](./kata/kata080.md)
81. [#081 - Retry Budget: Limited retries + jitter (anti-storm)](./kata/kata081.md)
82. [#082 - Idempotent Consumer: at-least-once + exactly-once effects](./kata/kata082.md)
83. [#083 - Saga Orchestration: workflow + compensate](./kata/kata083.md)
 - [#083.1 - Bonus - Event-driven Saga: Commands ↔ Events + Compensations](./kata/kata083.1.md)
84. [#084 - Timeout & Deadline Propagation: end-to-end deadline](./kata/kata084.md)
85. [#085 - Partial Failure Handling: degrade gracefully](./kata/kata085.md)
86. [#086 - Multi-region: latency + consistency plan](./kata/kata086.md)
87. [#087 - Clock Skew Bugs: reproduce & fix](./kata/kata087.md)
88. [#088 - Poison Message: detect, quarantine, DLQ tools](./kata/kata088.md)
89. [#089 - Schema Evolution: backward/forward compatibility](./kata/kata089.md)
90. [#090 - Chaos Mini Drill: prove the system survives](./kata/kata090.md)
91. [#091 - Benchmark Harness (Node.js microbench đúng cách)](./kata/kata091.md)
92. [#092 - Profiling CPU: Find Hot Path, Optimize with Evidence](./kata/kata092.md)
 - 92.1 [#092.1 - Bonus - Staff-grade CPU Profiling](./kata/kata092.1.md)
93. [#093 - Memory Optimization: Reduce Allocations, Measure Heap](./kata/kata093.md)
94. [#094 - Cold Start: Optimize Boot Time (Boot/Init Latency)](./kata/kata094.md)
95. [#095 - Caching Strategy: What to Cache & Invalidation Plan](./kata/kata095.md)
96. [#096 - BFF vs API: Same Problem, Two Designs, One Decision](./kata/kata096.md)
97. [#097 - Testing Pyramid in Node: Unit / Integration / Contract / E2E](./kata/kata097.md)
98. [#098 - Flaky Test Killer: Create Flakes, Kill Them Deterministically](./kata/kata098.md)
99. [#099 - Release Playbook: Canary, Rollback, Feature Flag](./kata/kata099.md)
100. [#100 - Production Spec: System Intent + Failure Model + Ops Runbook](./kata/kata100.md)